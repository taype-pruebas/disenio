...
const FormTool = ({ setOpenRegister }) => {
  ...
  const categorySchema = Yup.object().shape({
    ...
    tool_description: Yup.string()
      .min(15, "descripcion muy pequeño.")
      .required("descripcion de usuario es requerido."),
    tool_image: Yup.string()
      .min(15, "descripcion muy pequeño.")
      .required("descripcion de usuario es requerido."),
    tool_link: Yup.string()
      .min(15, "descripcion muy pequeño.")
      .required("descripcion de usuario es requerido."),
    tool_category: Yup.string()
      .min(15, "descripcion muy pequeño.")
      .required("descripcion de usuario es requerido."),
    user_created: Yup.string()
      .min(15, "descripcion muy pequeño.")
      .required("descripcion de usuario es requerido."),
  });
    ...
    >
      <section className={styles.containerLogin}>
        ...
        <section className={styles.header}>
          <h1>Dev Connect</h1>
          <p>Crea una nueva herramienta</p>
        </section>
